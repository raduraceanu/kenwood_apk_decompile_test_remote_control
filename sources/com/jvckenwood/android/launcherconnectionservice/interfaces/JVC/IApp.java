...
public interface IApp extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IApp {
        private static final String DESCRIPTOR = "com.jvckenwood.android.launcherconnectionservice.interfaces.JVC.IApp";
        ...
        private static class Proxy implements IApp {
            ...
            @Override // com.jvckenwood.android.launcherconnectionservice.interfaces.JVC.IApp
